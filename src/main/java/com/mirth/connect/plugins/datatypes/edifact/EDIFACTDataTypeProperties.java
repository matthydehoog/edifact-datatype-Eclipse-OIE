...
public class EDIFACTDataTypeProperties extends DataTypeProperties {

    public EDIFACTDataTypeProperties() {
        serializationProperties = new EDIFACTSerializationProperties();
        batchProperties = new EDIFACTBatchProperties();
    }
